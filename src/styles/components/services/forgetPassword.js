...
const useStyles = makeStyles((theme) => ({
  ...
  field: {
    ...
    "& .MuiFormControl-root": {
      ...
      "& .MuiInputBase-root": {
        border: "none",
        backgroundColor: theme.globals.colors.field,
        "& .MuiInputBase-input": {
          border: "none",
          color: `${theme.globals.colors.bgWhite}!important`,
          maxHeight: 50,
  ...
  label: {
    ...
    color: theme.globals.colors.label,
    fontWeight: theme.globals.fontWeight.s,
    marginBottom: 4,
    "& .MuiInputBase-root": {
      "& .MuiInputBase-input": {
        color: `${theme.globals.colors.white}!important`,
        webkitTextFillColor: `${theme.globals.colors.white}!important`,
      },
